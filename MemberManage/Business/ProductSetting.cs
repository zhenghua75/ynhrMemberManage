...
namespace MemberManage.Business
{
	...
	/// </summary>
    public class ProductSetting : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.ultraGrid1.Size = new System.Drawing.Size(544, 248);
            this.ultraGrid1.TabIndex = 6;
            this.ultraGrid1.Text = "产品列表";
            ...
            this.ultraGrid2.Size = new System.Drawing.Size(544, 248);
            this.ultraGrid2.TabIndex = 7;
            this.ultraGrid2.Text = "产品参数设置";
            ...
            // ultraLabel5
            // 
            this.ultraLabel5.Location = new System.Drawing.Point(48, 72);
            ...
            // ultraLabel3
            // 
            this.ultraLabel3.Location = new System.Drawing.Point(48, 32);
            this.ultraLabel3.Name = "ultraLabel3";
            this.ultraLabel3.Size = new System.Drawing.Size(100, 23);
            this.ultraLabel3.TabIndex = 0;
            this.ultraLabel3.Text = "产品：";
            // 
            // ProductSetting
            // 
		...
		private void MemberSetting_Load(object sender, System.EventArgs e)
		{
			...
			BindNamecode();
			BindMemberRight();
			Helper.BindNameCodeProductType(cmbType);
		...
		private void BindNamecode()
		{
			try
			{
                DataTable dtNameCode = Helper.Query("select * from tbNameCode  where cnvcType='" + ConstApp.Product + "' order by cnvcCodeId,cnvcType,cnvcValue");
...
//					string strMinute = strValues[1];
                ...
                string strSql = "select * from tbJob where convert(varchar(100),cnvcJobTheme)='" + strValue + "' ";
                DataTable dtJob = Helper.Query(strSql);
                if (dtJob.Rows.Count > 0) throw new BusinessException("商品管理", "招聘会已使用不能修改");
		...
		private void btnMemberModify_Click(object sender, System.EventArgs e)
		{
			try
			{
                ...
                strSql = "select * from tbJob where convert(varchar(100),cnvcJobTheme)='" + cmbMember.Text + "' and GETDATE() between cndBeginDate and cndEndDate";
                DataTable dtJob = Helper.Query(strSql);
                if (dtJob.Rows.Count > 0) throw new BusinessException("商品管理", "招聘会已开始不能修改");
		...
		private void ultraGrid1_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
            ...
            e.Layout.Bands[0].Columns["cnvcCodeID"].Header.Caption = "产品ID";
            e.Layout.Bands[0].Columns["cnvcType"].Hidden = true;
			e.Layout.Bands[0].Columns["cnvcType"].Header.Caption = "参数类型";
			e.Layout.Bands[0].Columns["cnvcValue"].Header.Caption = "产品";
			e.Layout.Bands[0].Columns["cnvcType"].Width = 150;
			e.Layout.Bands[0].Columns["cnvcValue"].Width = 500;
		}
		...
		private void cmbMember_ValueChanged(object sender, System.EventArgs e)
		{
			if (cmbMember.SelectedItem != null)
			{
				...
				string strSql = "select *  from tbMemberCode where  cnvcMemberName = '"+cmbMember.Text+"' and cnvcMemberType in ('"+ConstApp.ProductPrice+"','"+ConstApp.ProductDiscount+"','"+ConstApp.ProductPoints+"')";
				DataTable dtMemberCode = Helper.Query(strSql);
