...
namespace MemberManage.Business
{
    ...
    public class MemberFileQuery : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.ultraGroupBox1.Size = new System.Drawing.Size(952, 176);
            ...
            this.cmbEndDateBegin.Location = new System.Drawing.Point(656, 48);
            ...
            this.chkEndDateBegin.Location = new System.Drawing.Point(536, 48);
            ...
            this.btnModify.Location = new System.Drawing.Point(832, 112);
            ...
            this.cmbEndDate2.Location = new System.Drawing.Point(656, 136);
            ...
            this.chkEndDate2.Location = new System.Drawing.Point(536, 136);
            ...
            this.cmdBeginDate.Location = new System.Drawing.Point(656, 112);
            ...
            this.chkBeginDate.Location = new System.Drawing.Point(536, 112);
            ...
            this.chkEndDate.Location = new System.Drawing.Point(536, 72);
            ...
            // ultraLabel8
            // 
            this.ultraLabel8.Location = new System.Drawing.Point(544, 8);
            ...
            this.txtCustomerService.Location = new System.Drawing.Point(656, 8);
            ...
            this.btnExcel.Location = new System.Drawing.Point(832, 80);
            ...
            this.btnPrint.Location = new System.Drawing.Point(832, 48);
            ...
            this.btnQuery.Location = new System.Drawing.Point(832, 16);
            ...
            // ultraGroupBox3
            // 
            this.ultraGroupBox3.Location = new System.Drawing.Point(520, 96);
            ...
            // ultraGroupBox4
            // 
            this.ultraGroupBox4.Location = new System.Drawing.Point(520, 32);
            ...
            this.Text = Login.constApp.strCardTypeL8Name + "会员档案报表";
		...
		private void PopulateValueList()
		{
            ...
            DataTable dtCustomerService = Helper.Query("select distinct cnvcCustomerService from tbMember where Len(cnvcMemberCardNo)=8 and cnvcCustomerService is not null");
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string strSql = "select "
                              ...
                              + " cnnPrepay,convert(char(10),cast(cndEndDate as datetime),121) as cndEndDate,cnvcOperName,cndOperDate,cnvcMobileTelePhone,cnvcPostalCode,cnvcSales,cnvcHandleman,cnvcHandlemanPaperNo, "
							  ...
							  + " when 2 then '触摸屏操作'  "
                              + " when 3 then '客服预定' "
                              + " end cnvcSynch,cndInNetDate from tbMember where Len(cnvcMemberCardNo)=8 ";
