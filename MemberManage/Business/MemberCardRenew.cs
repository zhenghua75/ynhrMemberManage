...
namespace MemberManage.Business
{
    ...
    public class MemberCardRenew : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.ultraGroupBox3.Controls.Add(this.txtPrepay);
            ...
            this.Text = Login.constApp.strCardTypeL8Name + "发卡";
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string strSql = "select *,cnvcMemberCardNo as cnvcOldMemberCardNo from tbMember where Len(cnvcMemberCardNo)=8 and cnvcState='"+ConstApp.Card_State_NoCard+"' ";
