...
namespace MemberManage.Business
{
    ...
    public class JobQuery : frmBase
	{
		...
		private void InitializeComponent()
		{
			...
			// ultraGrid1
			// 
			this.ultraGrid1.Location = new System.Drawing.Point(104, 232);
			this.ultraGrid1.Name = "ultraGrid1";
			this.ultraGrid1.Size = new System.Drawing.Size(784, 328);
		...
		private void ultraGrid1_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
			...
			e.Layout.Bands[0].Columns["cndBeginDate"].Width = 120;
			e.Layout.Bands[0].Columns["cndEndDate"].Width = 120;
			e.Layout.Bands[0].Columns["cndBookBeginDate"].Width = 120;
			e.Layout.Bands[0].Columns["cndBookEndDate"].Width = 120;
