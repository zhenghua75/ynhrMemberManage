...
namespace MemberManage.Business
{
    ...
    public class MemberCardInlose : frmBase
	{
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                string strSql = "select top 100 cnvcMemberCardNo,cnvcMemberName,cnvcPaperNo,cnvcMemberRight,cnvcDiscount,cnvcFree,cnnMemberFee,cnnPrepay from tbMember where Len(cnvcMemberCardNo)=8 and cnvcState='" + ConstApp.Card_State_InUse + "' and cndEndDate>=getdate()";
