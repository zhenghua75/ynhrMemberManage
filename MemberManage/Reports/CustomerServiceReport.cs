...
namespace MemberManage.Reports
{
	...
	/// </summary>
    public class CustomerServiceReport : frmBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGroupBox1.Size = new System.Drawing.Size(952, 184);
			...
			this.cmbEndDate2.Location = new System.Drawing.Point(656, 144);
			...
			this.chkEndDate2.Location = new System.Drawing.Point(536, 144);
			...
			this.cmdBeginDate.Location = new System.Drawing.Point(656, 120);
			...
			this.chkBeginDate.Location = new System.Drawing.Point(536, 120);
			...
			this.cmbEndDate.Location = new System.Drawing.Point(656, 80);
			...
			this.chkEndDate.Location = new System.Drawing.Point(536, 80);
			...
			// ultraLabel8
			// 
			this.ultraLabel8.Location = new System.Drawing.Point(544, 16);
			...
			this.txtCustomerService.Location = new System.Drawing.Point(656, 16);
			...
			this.txtSales.Location = new System.Drawing.Point(408, 112);
			...
			this.btnExcel.Location = new System.Drawing.Point(832, 88);
			...
			this.btnPrint.Location = new System.Drawing.Point(832, 56);
			...
			this.btnQuery.Location = new System.Drawing.Point(832, 24);
			...
			// ultraGroupBox3
			// 
			this.ultraGroupBox3.Location = new System.Drawing.Point(520, 104);
			this.ultraGroupBox3.Name = "ultraGroupBox3";
			this.ultraGroupBox3.Size = new System.Drawing.Size(296, 64);
			this.ultraGroupBox3.TabIndex = 41;
			this.ultraGroupBox3.Text = "操作时间段";
			// 
			// cmbEndDateBegin
			// 
			this.cmbEndDateBegin.BackColor = System.Drawing.SystemColors.Window;
			this.cmbEndDateBegin.DateButtons.Add(dateButton2);
			this.cmbEndDateBegin.Location = new System.Drawing.Point(656, 56);
			...
			this.cmbEndDateBegin.TabIndex = 43;
			// 
			// chkEndDateBegin
			// 
			this.chkEndDateBegin.GlyphStyle = Infragistics.Win.GlyphStyle.Office2007;
			this.chkEndDateBegin.Location = new System.Drawing.Point(536, 56);
			this.chkEndDateBegin.Name = "chkEndDateBegin";
			this.chkEndDateBegin.TabIndex = 42;
			this.chkEndDateBegin.Text = "开始时间";
			// 
			// ultraGroupBox4
			// 
			this.ultraGroupBox4.Location = new System.Drawing.Point(520, 40);
			...
			this.btnModify.Location = new System.Drawing.Point(832, 128);
			...
			this.Name = "CustomerServiceReport";
			this.Text = "客服会员报表";
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string strSql = "select "
                              ...
                              + " cnvcCompanyAddress,cnvcLinkman,cnvcLinkPhone,cnvcEmail,cnvcEmail as cnvcOldEmail,cnvcFax,cnvcFax as cnvcOldFax,cnvcComments,cnvcMemberRight,cnvcEnterpriseType,cnvcDiscount,cnvcFree,cnvcProduct,cnvcState,cnnMemberFee, "
                              + " cnnPrepay,convert(char(10),cast(cndEndDate as datetime),121) as cndEndDate,cnvcOperName,cndOperDate,cnvcMobileTelePhone,cnvcMobileTelePhone as cnvcOldMobileTelePhone,cnvcPostalCode,cnvcPostalCode as cnvcOldPostalCode,cnvcSales,cnvcHandleman,cnvcHandlemanPaperNo, "
                              + " cnvcTrade,cnvcCustomerService,cnvcCustomerService as cnvcOldCustomerService "
					          + " ,case cniSynch "
					          + " when 0 then '会员系统' "
							  + " when 1 then '网站操作' "
							  + " when 2 then '触摸屏操作'  "
                              + " end cnvcSynch,cndInNetDate from tbMember where cnvcCustomerService='"+this.oper.cnvcOperName+"' ";
...
//					}
		...
		{
			Helper.PrintDisplay(e,"云南人才市场客服会员报表");
		}
		...
		private void ultraGrid1_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
			...
			e.Layout.Bands[0].Columns["cnvcFax"].CellActivation = Activation.AllowEdit;
			e.Layout.Bands[0].Columns["cnvcOldFax"].Hidden = true;
			...
			e.Layout.Bands[0].Columns["cnvcEmail"].CellActivation = Activation.AllowEdit;
			e.Layout.Bands[0].Columns["cnvcOldEmail"].Hidden = true;
			...
			e.Layout.Bands[0].Columns["cnvcMobileTelephone"].CellActivation = Activation.AllowEdit;
			e.Layout.Bands[0].Columns["cnvcOldMobileTelephone"].Hidden = true;
			e.Layout.Bands[0].Columns["cnvcPostalCode"].Header.Caption = "邮政编码";
			e.Layout.Bands[0].Columns["cnvcPostalCode"].CellActivation = Activation.AllowEdit;
			e.Layout.Bands[0].Columns["cnvcOldPostalCode"].Hidden = true;
			...
			e.Layout.Bands[0].Columns["cnvcSynch"].Hidden = true;
		...
		private void btnExcel_Click(object sender, System.EventArgs e)
		{
            ...
            ClientHelper.ExportExcel(saveFileDialog1, ultraGridExcelExporter1, this.ultraGrid1, "云南人才市场客服会员报表", this.oper.cnvcOperName);
		}
		...
		private void btnModify_Click(object sender, System.EventArgs e)
		{
			...
			{
				//,,,,,
				//CardNo|Email|Fax|phone|Postal|cust|,
				string strMemberCardNo = "";
				foreach (UltraGridRow row in this.ultraGrid1.Rows)
				{
					strMemberCardNo += row.Cells["cnvcMemberCardNo"].Value.ToString();
					string strOldEmail = row.Cells["cnvcOldEmail"].Value.ToString();
					string strEmail = row.Cells["cnvcEmail"].Value.ToString();

					if(!strOldEmail.Equals(strEmail))
					{
						strMemberCardNo += "|"+row.Cells["cnvcEmail"].Value.ToString();
					}
					else
						strMemberCardNo += "|";

					string strOldFax = row.Cells["cnvcOldFax"].Value.ToString();
					string strFax = row.Cells["cnvcFax"].Value.ToString();
					if(!strOldFax.Equals(strFax))
					{
						strMemberCardNo += "|"+row.Cells["cnvcFax"].Value.ToString();
					}
					else
						strMemberCardNo += "|";


					string strOldMobileTelephone = row.Cells["cnvcOldMobileTelephone"].Value.ToString();
					string strMobileTelephone = row.Cells["cnvcMobileTelephone"].Value.ToString();
					if(!strOldMobileTelephone.Equals(strMobileTelephone))
					{
						strMemberCardNo += "|"+row.Cells["cnvcMobileTelephone"].Value.ToString();
					}
					else
						strMemberCardNo += "|";


					string strOldPostalCode = row.Cells["cnvcOldPostalCode"].Value.ToString();
					string strPostalCode = row.Cells["cnvcPostalCode"].Value.ToString();
					if(!strOldPostalCode.Equals(strPostalCode))
					{
						strMemberCardNo += "|"+row.Cells["cnvcPostalCode"].Value.ToString();
					}
					else
						strMemberCardNo += "|";
					...
					if (!strOldCustomerService.Equals(strCustomerService))
					{
						...
						//{
						strMemberCardNo += "|"+row.Cells["cnvcCustomerService"].Value.ToString();
						//}
					}
					else
						strMemberCardNo += "|,";
				...
				//{
					...
					mm.CustomerServiceReportModify(strMemberCardNo);
