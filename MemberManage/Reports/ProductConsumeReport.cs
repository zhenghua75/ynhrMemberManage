...
namespace MemberManage.Reports
{
    ...
    public class ProductConsumeReport : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.btnExcel.Location = new System.Drawing.Point(768, 112);
            ...
            this.ultraButton1.Location = new System.Drawing.Point(664, 112);
            ...
            this.btnQuery.Location = new System.Drawing.Point(560, 112);
            ...
            this.Text = Login.constApp.strCardTypeL8Name + "服务产品充值缴费报表";
...
//			dtState.Rows.Add(drState3);
            ...
            //{
            //    if(!Login.constApp.alOperFunc.Contains("服务产品充值缴费报表查询"))
            //    {
            //        this.btnQuery.Enabled = false;
            //    }
            //    if(!Login.constApp.alOperFunc.Contains("服务产品充值缴费报表打印"))
            //    {
		...
		private void ultraGrid1_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
			...
			//e.Layout.Bands[0].Columns["cnnPrepay"].Header.Caption = "会员状态";	
			e.Layout.Bands[0].Columns["cnvcProductDiscount"].Header.Caption = "产品折扣";	
			e.Layout.Bands[0].Columns["cnvcProductName"].Header.Caption = "服务产品";	
		...
		{
			Helper.PrintDisplay(e,"云南人才市场服务产品消费报表");	
		}
