...
namespace MemberManage.Reports
{
    ...
    public class OperLogReport : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.Text = Login.constApp.strCardTypeL8Name + "操作日志报表";
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string strSql = "select a.cnvcOperName,a.cndOperDate,a.cnvcMemberCardNo,a.cnvcPaperNo,"
					          +" case when b.cnvcMemberName is null then c.cnvcMemberName"
							  +" when c.cnvcMemberName is null then b.cnvcMemberName"
