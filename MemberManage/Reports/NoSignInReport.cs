...
{
	/// <summary>
	/// Summary description for NoSignInReport.
	/// </summary>
    public class NoSignInReport : frmBase
	{
		...
		private void NoSignInReport_Load(object sender, System.EventArgs e)
		{
            ...
            //{
            //    if(!Login.constApp.alOperFunc.Contains("展位调整报表查询"))
            //    {
            //        this.btnQuery.Enabled = false;
            //    }
            //    if(!Login.constApp.alOperFunc.Contains("展位调整报表打印"))
            //    {
		...
		{
			Helper.PrintDisplay(e,"云南人才市场展位调整报表");		

		}

		private void btnExcel_Click(object sender, System.EventArgs e)
		{
            ClientHelper.ExportExcel(saveFileDialog1, ultraGridExcelExporter1, ultraGrid1, "云南人才市场展位调整报表", this.oper.cnvcOperName);
		}

		private void ultraGrid1_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
			Helper.SetGridDisplay(e); 
			e.Layout.Bands[0].Columns["cnvcState"].Header.Caption = "展位状态";
