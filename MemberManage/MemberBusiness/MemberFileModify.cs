...
namespace MemberManage.MemberBusiness
{
    ...
    public class MemberFileModify : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.ultraGrid1.Size = new System.Drawing.Size(400, 492);
            ...
            // ultraGroupBox2
            // 
            this.ultraGroupBox2.Controls.Add(this.cmbDiscount);
            ...
            this.ultraGroupBox2.Size = new System.Drawing.Size(608, 492);
            ...
            this.cmbSales.Location = new System.Drawing.Point(424, 253);
            ...
            this.cmbHandleMan.Location = new System.Drawing.Point(136, 288);
            this.cmbHandleMan.Name = "cmbHandleMan";
            this.cmbHandleMan.Size = new System.Drawing.Size(152, 21);
            this.cmbHandleMan.TabIndex = 58;
            // 
            // txtFax
            // 
            ...
            // ultraLabel25
            // 
            this.ultraLabel25.Location = new System.Drawing.Point(320, 288);
            ...
            // ultraLabel20
            // 
            this.ultraLabel20.Location = new System.Drawing.Point(320, 256);
            ...
            this.txtCommnets.Location = new System.Drawing.Point(136, 381);
            ...
            // ultraLabel11
            // 
            this.ultraLabel11.Location = new System.Drawing.Point(32, 389);
            ...
            this.btnCancel.Location = new System.Drawing.Point(336, 453);
            ...
            this.btnModify.Location = new System.Drawing.Point(200, 453);
            ...
            // ultraLabel13
            // 
            this.ultraLabel13.Location = new System.Drawing.Point(31, 349);
            this.ultraLabel13.Name = "ultraLabel13";
            this.ultraLabel13.Size = new System.Drawing.Size(104, 23);
            this.ultraLabel13.TabIndex = 64;
            this.ultraLabel13.Text = "折扣：";
            // 
            // label1
            // 
            this.label1.AutoSize = true;
            this.label1.Location = new System.Drawing.Point(294, 353);
            ...
            this.cmbDiscount.Location = new System.Drawing.Point(136, 349);
            this.cmbDiscount.Name = "cmbDiscount";
            this.cmbDiscount.Size = new System.Drawing.Size(152, 21);
            this.cmbDiscount.TabIndex = 66;
            // 
            // MemberFileModify
            // 
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                string strSql = "select top 100 cnvcMemberCardNo,cnvcMemberName,cnvcPaperNo,cnvcMemberRight,cnvcDiscount,cnnPrepay,cnvcState,cndInNetDate from tbMember where Len(cnvcMemberCardNo)=6 and cnvcState in ('" + ConstApp.Card_State_InUse + "','"+ConstApp.Card_State_NoCard+"')";
...
//				}
		...
		private void btnModify_Click(object sender, System.EventArgs e)
		{
			try
			{
                ...
                if (txtMemberPwd.Text.Length < 6) throw new BusinessException("发卡", "会员密码最少6位");
				#endregion
                ...
                string strEndDate = cmdEndDate.Text;
                if (cmdEndDate.Text == "(none)") strEndDate = "9999-12-31";
                member.cndEndDate = strEndDate;
		...
		private void ultraGrid1_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
            ...
            e.Layout.Bands[0].Columns["cnvcState"].Header.Caption = "状态";
		...
		{			
			try
			{
				...
				if (null != row)
				{
                    ...
                    cmdEndDate.Text = member.cndEndDate;
                    cmbDiscount.Text = member.cnvcDiscount;
