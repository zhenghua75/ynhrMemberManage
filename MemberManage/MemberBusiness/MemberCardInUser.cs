...
namespace MemberManage.MemberBusiness
{
    ...
    public class MemberCardInUser : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.btnInUse.Location = new System.Drawing.Point(56, 158);
            ...
            this.Text = Login.constApp.strCardTypeL6Name + "解挂";
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                string strSql = "select top 100 cnvcMemberCardNo,cnvcMemberName,cnvcPaperNo,cnvcMemberRight,cnvcDiscount,cnvcFree,cnnMemberFee,cnnPrepay from tbMember where Len(cnvcMemberCardNo)=6 and cnvcState='" + ConstApp.Card_State_InLose + "' and CAST (case when cndEndDate ='(none)' then '9999-12-31' else cndEndDate end as DateTime) >=getdate()";
