...
namespace MemberManage.MemberBusiness
{
    ...
    public class MemberCardAddCard : frmBase
	{
		...
		private void InitializeComponent()
		{
            ...
            this.btnAddCard.Location = new System.Drawing.Point(53, 169);
            ...
            this.txtNewMemberCardNo.Location = new System.Drawing.Point(138, 64);
            ...
            this.Text = Login.constApp.strCardTypeL6Name + "补卡";
		...
		private void ultraButton1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                string strSql = "select top 10 cnvcMemberCardNo,cnvcMemberName,cnvcPaperNo,cnvcMemberRight,cnvcDiscount,cnvcFree,cnnMemberFee,cnnPrepay from tbMember where LEN(cnvcMemberCardNo)=6 and cnvcState='" + ConstApp.Card_State_InLose + "' and CAST (case when cndEndDate ='(none)' then '9999-12-31' else cndEndDate end as DateTime) >=getdate()";
		...
		private void btnAddCard_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				if (txtNewMemberCardNo.Text.Trim().Length == 0 )
				{
					throw new BusinessException("补卡","请输入新会员卡号！");
				}
