...
namespace ynhrMemberManage.Domain
{
	...
	[Serializable]
	[TableMapping("tbShow")]
	public class Show: ynhrMemberManage.ORM.EntityObjectBase
	{
		#region 数据表生成变量
		...
		public Show(DataTable table):base(table)
		{
		}
		
		public Show(string  strXML):base(strXML)
		{
		}
		#endregion
		...
		/// 展厅ID
		/// </summary>
		[ColumnMapping("cnnShowID",IsPrimaryKey=true,IsIdentity=false,IsVersionNumber=false)]
