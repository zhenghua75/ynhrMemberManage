...
namespace ynhrMemberManage.Domain
{
    ...
    /// </summary>
    [Serializable]
    [TableMapping("tbMemberProductLog")]
    public class MemberProductLog : ynhrMemberManage.ORM.EntityObjectBase
    {
        #region 数据表生成变量
        ...
        #region 构造函数
        public MemberProductLog()
            : base()
        {
        }

        public MemberProductLog(DataRow row)
            : base(row)
        {
        }

        public MemberProductLog(DataTable table)
            : base(table)
        {
        }

        public MemberProductLog(string strXML)
            : base(strXML)
        {
        }
        #endregion
