...
namespace ynhrMemberManage.Domain
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbMemberLog")]
	public class MemberLog: ynhrMemberManage.ORM.EntityObjectBase
	{
		#region 数据表生成变量
		...
		#region 构造函数
		public MemberLog():base()
		{
		}
		
		public MemberLog(DataRow row):base(row)
		{
		}
		
		public MemberLog(DataTable table):base(table)
		{
		}
		
		public MemberLog(string  strXML):base(strXML)
		{
		}
		#endregion
