...
namespace ynhrMemberManage.Domain
{
    ...
    /// </summary>
    [Serializable]
    [TableMapping("tbFMember")]
    public class FMember : ynhrMemberManage.ORM.EntityObjectBase
    {
        #region 数据表生成变量
        ...
        public FMember(DataRow row)
            : base(row)
        {
        }

        public FMember(DataTable table)
            : base(table)
        {
        }

        public FMember(string strXML)
            : base(strXML)
        {
        }
        #endregion
