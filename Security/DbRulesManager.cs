...
namespace ynhrMemeberManage.Security
{
	...
	/// </summary>
	public class DbRulesManager : IDbRulesManager
	{
		...
		/// </summary>
		/// <param name="databaseService">数据库连接字符串名称</param>
		...
		public void UpdateRuleById(int ruleId, string name, string description,string expression)
		{
        ...
        public void UpdateRuleByName(string ruleName,string ruleExpression)
        {
