...
//using ynhrMemeberManage.Business;
#endregion
...
namespace ynhrMemberManage.Print
{
	...
	[Serializable]
	[TableMapping("tbBill")]
	public class PrintedBill: ynhrMemberManage.ORM.EntityObjectBase,IPrintable
	{
		#region 数据表生成变量
		private int _cnnID;
        ...
        private bool _cnbFeeType = false;
		#endregion
		
		#region 构造函数
		public PrintedBill():base()
		{
		}
		
		public PrintedBill(DataRow row):base(row)
		{
		}
		
		public PrintedBill(DataTable table):base(table)
		{
		}
		
		public PrintedBill(string  strXML):base(strXML)
		{
		}
		#endregion
        ...
        ///免费场次剩余
        ///</summary>
        [ColumnMapping("cnbFeeType", IsPrimaryKey = false, IsIdentity = false, IsVersionNumber = false)]
        public bool cnbFeeType
        {
            get { return _cnbFeeType; }
            set { _cnbFeeType = value; }
        }
		/// <summary>
		/// 卡使用时限
		/// </summary>
